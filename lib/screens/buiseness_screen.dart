...
import 'package:books_projects/widgets/custom_list_business.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';


class BuisenessScreen extends StatelessWidget {
  const BuisenessScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => HomeCubit()..getBusinessBooks(),
      child: Scaffold(
        appBar: AppBar(
            ...
            BlocBuilder<HomeCubit, HomeState>(
              builder: (context, state) {
                ...
                if (state is HomeLoading) {
                  ...
                  return const CustomListBusiness();
                }
              },
            ),
          ],
